...
BEGIN
    ...
    -- Create a temporary table to store results with MIN/MAX values
    ...
    -- === Error Handling ===
    BEGIN CATCH
        -- Close and deallocate the cursor if it's still open
...
/*
SchemaName  TableName     ColumnName    ColumnCode       PropertyValue              MinDistinctValue  MaxDistinctValue
----------- ------------- ------------- ---------------- -------------------------- ----------------- -----------------
mrs         Orders        OrderID       ORD_PrimaryKey   Primary key for Orders     1000001           9999999
mrs         Orders        CustomerID    FK_CustomerID    Foreign key to Customers   CUST001           CUST999
mrs         Orders        StatusCode    ORD_StatusCode   Order status identifier    CANCELED          SHIPPED
mrs         Customers     CustomerID    CUST_PrimaryKey  Primary key for Customers  CUST001           CUST999
mrs         Products      ProductCode   PROD_Code        Product identifier code    A001-XZ           Z999-YY
*/
*/
GO