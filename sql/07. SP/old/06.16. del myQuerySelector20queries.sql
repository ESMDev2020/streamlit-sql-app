...
EXEC [mrs].[mysp_QuerySelector] 'ROP_PRICE'
EXEC [mrs].[mysp_QuerySelector] 'ROP_MP'	-- start with 4. ie. 401785 - Transaction4, vendor, ITEM, qty
EXEC [mrs].[mysp_QuerySelector] 'ROP_PO'	-- Start with 5. ie. 518046. Transaction. vendor, ITEM, QTY, dates
EXEC [mrs].[mysp_QuerySelector] 'ROP_ROP'	-- ITEM, quantity
EXEC [mrs].[mysp_QuerySelector] 'SALES_DATA'-- Starts with 9. Transaction ODORDR 970660. Transaction, item, customer
EXEC [mrs].[mysp_QuerySelector] 'TAG'		-- pending	-- ITEM, TAG, Heat, Mill, Warehouse, Tag, Qty

EXEC [mrs].[mysp_QuerySelector] 'USAGE'		-- ITEM, Transaction type, number, vendor, customer, date
EXEC [mrs].[mysp_QuerySelector] 'USAGE_SUM'	-- ITEM, transaction type, customer
EXEC [mrs].[mysp_QuerySelector] 'CM'		-- Order, type, customer, ITEM, 
EXEC [mrs].[mysp_QuerySelector] 'CUST_SUM'
EXEC [mrs].[mysp_QuerySelector] 'CUST_SUM1'
EXEC [mrs].[mysp_QuerySelector] 'ITEMONHD'
EXEC [mrs].[mysp_QuerySelector] 'SALES_ORDERS'
EXEC [mrs].[mysp_QuerySelector] 'SPO'
EXEC [mrs].[mysp_QuerySelector] 'SHIPMAST'
EXEC [mrs].[mysp_QuerySelector] 'GLTRANS'
EXEC [mrs].[mysp_QuerySelector] 'SHIPMENTS'
*/
