...
EXEC [mrs].[mysp_QuerySelector] 'ROP_MP'	-- start with 4. ie. 401785
EXEC [mrs].[mysp_QuerySelector] 'ROP_PO'	-- Start with 5. ie. 518046
EXEC [mrs].[mysp_QuerySelector] 'ROP_ROP'
EXEC [mrs].[mysp_QuerySelector] 'SALES_DATA'
EXEC [mrs].[mysp_QuerySelector] 'TAG'
EXEC [mrs].[mysp_QuerySelector] 'USAGE'
EXEC [mrs].[mysp_QuerySelector] 'USAGE_SUM'
EXEC [mrs].[mysp_QuerySelector] 'CM'
